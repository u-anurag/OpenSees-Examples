## Original script can be downloaded from Xin-Zheng Lu's website ## 
...
## Create an output database to be read by OpenSeesPy visualization library
## Database name = CantiBeam_ODB, loadcase name = Push, recorded modeshapes = 0

source Get_Rendering.tcl 
createODB "CantiBeam" "Push" 0 
